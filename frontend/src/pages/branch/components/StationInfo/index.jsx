          ...
          <div>
            ...
            <div className="flex column center station-hours">
              ...
              <div className="white-bg flex align-center justify-between">
                <input type="time" value={opening_time} onChange={(e) => setOpening_time(e.target.value)} />
              </div>

              <p>Till: </p>
              <div className="white-bg flex align-center justify-between">
                <input type="time" value={closing_time} onChange={(e) => setClosing_time(e.target.value)} />
              </div>
